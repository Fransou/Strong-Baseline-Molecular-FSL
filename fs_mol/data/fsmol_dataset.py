...
class FSMolDataset:
    ...
    def __init__(
        ...
        self._num_workers = 0  # num_workers if num_workers is not None else os.cpu_count() or 1
        ...
        def get_fold_file_names(data_fold_name: str):
            ...
            if task_list is None:
                ...
                return [
                    ...
                    if any(file_name.basename() == f"{task_name}.jsonl.gz" for task_name in task_list[data_fold_name])
                ]
