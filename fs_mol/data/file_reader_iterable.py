...
from typing import List, Iterator, TypeVar, Callable, Iterable, Union, Type, Optional
    ...
    try:
        ...
        while not termination_signal.is_set():
            try:
                ...
                logger.warn(f"Process {os.getpid()} threw {type(e)} exception when trying to read files {paths}.")
                import traceback
