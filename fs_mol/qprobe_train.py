...
from fs_mol.configs import GnnPreTrainingConfig
...
def parse_command_line():
    ...
    parser.add_argument(
        "--model_config",
        type=str,
        default="fs_mol/configs/QP/train.json",
...
if __name__ == "__main__":
    ...
    name = (
        name if not name == "" else f"""Qprobe_pretr_{time.strftime("%d_%b_%H_%M", time.localtime())}"""
    )
    ...
    model_config = GnnPreTrainingConfig(**model_config)
